"""
Django settings for reviewapptest3462_1 project.
...
ROOT_URLCONF = 'reviewapptest3462_1.urls'
...
WSGI_APPLICATION = 'reviewapptest3462_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "reviewapptest3462_1 API",
    "DESCRIPTION": "API documentation for reviewapptest3462_1 App",
    "VERSION": "v1",
}
